//Creating a project for Online Examination using java Programming Language By HARSH...
...
public class OnlineExam {
    ...
    void login() {
        ...
        if (username.equals("harsh") && password ==2002) {
    ...
    public void examination() {
		...
		{
    	System.out.println("You have 5 questions and time limit is 5 minutes");
		System.out.println("");
		System.out.println("Each quesetion for 5 marks and negative marking is there...");
		System.out.println("");
